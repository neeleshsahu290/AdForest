...
public class MultiSpinnerSearch extends AppCompatSpinner implements DialogInterface.OnCancelListener {
    ...
    private String searchHint = getContext().getString(R.string.search_hint);
    private String clearText = getContext().getString(R.string.clearall);
    ...
    private boolean isImageLeft=false;
    ...
    public boolean isImaageLeft() {
        return isImageLeft;
    }

    public void setImageLeft(boolean isimage) {
        isImageLeft = isimage;
    }
...
//            //Log.i(TAG, "getView() enter");
            ...
            if (convertView == null) {
                ...
                holder.imageView= convertView.findViewById(R.id.alertimg);
            ...
            try {
              ...
              //  if (isImaageLeft()==true){
                    JSONObject jsonObject = (JSONObject) data.getObject();
                    String url= jsonObject.getString("marque_image");
                    Glide
                            .with(mcontext)
                            .load(url)
                            .centerCrop()
               ...
               // }
                ...
                Log.d("jsonimageerror",e.toString());
            }
