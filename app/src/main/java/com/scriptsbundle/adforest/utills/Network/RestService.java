...
//endregion
    ...
    @Multipart
    @POST("/wp-json/adforest/v1/message/chat_media/")
    Call<ResponseBody> postUploadChatFile(
         //   @Part("m") RequestBody param,
            @Part("ad_id") RequestBody adId,
         @Part("sender_id") RequestBody issent,
    ...
    //Get city list api
    @POST("ad_post/get_city/")
    Call<ResponseBody> postGetCity(
            @HeaderMap Map<String, String> headers
    );

    //Get city list api
    @POST("ad_post/get_all_city/")
    Call<ResponseBody> postGetAllCity(
            @HeaderMap Map<String, String> headers
    );

    //Get city list api
    @POST("ad_post/get_town/")
    Call<ResponseBody> postGetTown(
            @Body JsonObject searchNdMore,
            @HeaderMap Map<String, String> headers
    );
    ...
    //Get load more ADs or search in Search Activity
    @POST("ad_post/model")
    Call<ResponseBody> postGetCarModel(
            @Body JsonObject searchNdMore,
            @HeaderMap Map<String, String> headers
    );
    ...
    @POST("ad/most-visited/")
    Call<ResponseBody> postGetLoadgetMyMostViewedDetails(
            @HeaderMap Map<String, String> headers
    );
    ...
    //Load more Favourite Ads
    @POST("ad/featured/")
    Call<ResponseBody> postGetLoadFeaturedAds(
            @HeaderMap Map<String, String> headers
    );
    ...
    //Load more Favourite Ads
    @POST("ad/favourite/")
    Call<ResponseBody> postGetLoadFavouriteAds(
            @HeaderMap Map<String, String> headers
    );
