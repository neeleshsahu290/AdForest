...
public class ItemCatgorySubListAdapter extends RecyclerView.Adapter<ItemCatgorySubListAdapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(CustomViewHolder holder, final int position) {
        ...
        Log.d("dateitem",list.get(position).getDate());
...
//        setScaleAnimation(holder.itemView);
        ...
        if(feedItem.getAuthor_type().matches("Dealer")){
            holder.ivDealer.setVisibility(View.VISIBLE);
        }else {
            holder.ivDealer.setVisibility(View.GONE);
        }
...
//        Animation anim = android.view.animation.AnimationUtils.loadAnimation(getApplicationContext(),R.anim.alpha);
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        private TextView titleTextView, pathTV, priceTV, locationTV,date;
        private ImageView mainImage,ivDealer;
        ...
        CustomViewHolder(View v) {
            ...
            ivDealer = v.findViewById(R.id.ivDealer);
