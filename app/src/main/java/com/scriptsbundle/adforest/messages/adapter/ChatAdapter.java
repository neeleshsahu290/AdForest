...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      //  int ismedia = message.get_is_media();
        ...
        if (!mediatype.equals("0")){
            ...
            // String file_format = message.getfile_format();

           // String  one= String.valueOf(file_format.equals("jpg"));
            ...
            if (mediatype.equals("img")){
                ...
                load(message.getBody()).into(imageView1);
               // message.setImage(message.getBody());
            ...
            if (mediatype.equals("pdf") ){
                try {
                    ...
                    fileLayout.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Helpers.Companion.downloadFile(context, message.getBody(), fileName);
                        }
                    });
