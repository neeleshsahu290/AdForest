...
import com.scriptsbundle.adforest.messages.RecievedOffers;
import com.scriptsbundle.adforest.messages.SendOffers;
...
//        }
    ...
    private void adforest_swipeRefresh() {
        ...
        try {
            if(currentFragment instanceof RecievedOffers){
                fragment= "RecievedOffers";
            }
            if (currentFragment instanceof  SendOffers){
                fragment="SendOffers";
            }
        }catch (Exception e){
...
//            }
                ...
                alert.setNegativeButton(settingsMain.getAlertCancelText(), (dialogInterface, i) -> dialogInterface.dismiss());
                alert.show();
            } else if (id == R.id.sentOffer) {
                replaceFragment(new SendOffers(), "Sent Offers");
            } /*else if (id == R.id.offerad) {
                replaceFragment(new RecievedOffers(), "Received Offers");
            } else if (id == R.id.blockeduser) {
                replaceFragment(new Block_Message_Fragment(), "Blocked Users");
