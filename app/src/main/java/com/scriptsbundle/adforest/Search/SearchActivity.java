...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBtn = findViewById(R.id.send_button);
    ...
    public void adforest_bannersAds() {
        if (settingsMain.getAdsShow() && !settingsMain.getBannerAdsId().equals("")) {
            if (settingsMain.getAdsPostion().equals("top")) {
                ...
                FrameLayout maimFrame = (FrameLayout) findViewById(R.id.frameContainer1);
    ...
    public void startFragment(Fragment someFragment) {
        ...
        Fragment fragment = fm.findFragmentById(R.id.frameContainer1);

        if (fragment == null) {
            fragment = someFragment;

            fm.beginTransaction()
                    .add(R.id.frameContainer1, fragment)
                    .commit();
        }
    }
