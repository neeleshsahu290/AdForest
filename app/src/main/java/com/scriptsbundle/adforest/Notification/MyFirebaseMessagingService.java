...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(String s) {
        super.onNewToken(s);
        Log.d("FireBase_token",s.toString());
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        Log.e("sendRegistrationToServer", "sendRegistrationToServer: " + token);
    }
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        Log.e("FireBase_token", "From: " + remoteMessage.getFrom());
        ...
        if (remoteMessage.getData().size() > 0) {
            Log.e( "Data_Payload: " , remoteMessage.getData().toString());
            try {
    ...
    private void handleDataMessage(RemoteMessage remoteMessage) {
        ...
        try {
            ...
            if (remoteMessage.getData().get("topic").equals("broadcast")) {
                ...
                Log.d("info_broadcat", broadcast.toString());
            ...
            if (remoteMessage.getData().get("topic").equals("chat")) {
                ...
                showNotificationMessage(getApplicationContext(), title, message, currentTime, ad_id, recieverId, senderId,
                        type, "", remoteMessage.getData().get("topic"),name);
            }
        } catch (Exception e) {
    ...
    private void showNotificationMessage(Context context, String title, String message, Date timeStamp, String ad_id, String recieverId, String senderId,
                                         String type, String imageURL, String topic,String name) {
        notificationUtils = new NotificationUtils(context);
        notificationUtils.showNotificationMessage(title, message, timeStamp, ad_id, recieverId, senderId, type, imageURL, topic,name);
    }
    ...
    private void showNotificationMessageWithBigImage(Context context, String title, String message, Date timeStamp, String ad_id, String recieverId,
                                                     String senderId, String type, String imageURL, String topic,String name) {
        notificationUtils = new NotificationUtils(context);
        notificationUtils.showNotificationMessage(title, message, timeStamp, ad_id, recieverId, senderId, type, imageURL, topic,name);
    }
}